...
import {create,getAll,update,remove,getByInstitute,getTopCourses,getTopStudents,performanceCompareController,performance} from "./result.controller";
...
router.get("/performance-compare",checkAuth,performanceCompareController);
